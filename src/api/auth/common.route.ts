...
// import { checkGithubStatus, getGithubActivitySummary, getTodayGithubActivitySummary, sendGithubConnectMessage, sendSimpleMessage, sendSlackDM } from '../../services/slack.service';
// import {User} from '../../models/user.model';
// import dotenv from 'dotenv';
// import { summarizeGithubActivity } from '../../services/ai.service';
...
//             try {
//                 const events  = await getGithubActivitySummary(user.githubUsername, user.githubToken);
//                 console.log('어제 활동 내역 : ', events );

//                 const summary = await summarizeGithubActivity(events);


//                 await sendSlackDM({
//                 slackId: user.slackId,
//                 slackToken: user.slackToken,
//                 text: summary || '어제 활동 내역이 없습니다.',
//                 });
//                 return;
//             } catch (err) {
...
//                 const summary = await summarizeGithubActivity(result);
